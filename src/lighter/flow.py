...
class Flow:
    ...
    def _unpack_batch(self, batch: Any, context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    def _run_criterion(self, context: dict[str, Any], criterion: Callable | None) -> dict[str, Any]:
    ...
    def _run_metrics(self, context: dict[str, Any], metrics: MetricCollection | None) -> dict[str, Any]:
    ...
    def _get_value(self, context: dict[str, Any], key: str | Callable | list) -> Any:
        """
    ...
    def _prepare_args_kwargs(
        self, context: dict[str, Any], config: dict[str, Any] | list[Any] | str
        ...
        if isinstance(config, str):
            args = [self._get_value(context, config)]
            return args, {}
        return [], {}
